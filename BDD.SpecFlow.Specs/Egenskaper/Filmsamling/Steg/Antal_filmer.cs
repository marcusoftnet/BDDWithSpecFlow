...
{
    [Binding]
    public class Antal_filmer
    {
        private global::BDD.SpecFlow.Domain.Model.Filmsamling filmsamling;
        private FuskKommandoKälla fuskKommandoKälla;
        private Vy vy;
        ...
        public void Givet_Att_Jag_Påbörjar_Min_Filmsamling_Från_Scratch()
        {
            ...
            filmsamling = new global::BDD.SpecFlow.Domain.Model.Filmsamling(filmRepository, vyRepository);

            fuskKommandoKälla = new FuskKommandoKälla(filmsamling);
        }
        ...
        {
            fuskKommandoKälla.KörKommando(kommando);
        }
